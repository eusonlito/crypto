...
CREATE TABLE `exchange` (
  ...
  KEY `exchange_product_fk` (`product_id`),
...
CREATE TABLE `order` (
  ...
  `price_stop` double NOT NULL DEFAULT '0',
...
CREATE TABLE `product` (
  ...
  `price_max` double NOT NULL DEFAULT '0',
  `price_decimal` smallint unsigned NOT NULL DEFAULT '0',
  `quantity_min` double NOT NULL DEFAULT '0',
  `quantity_max` double NOT NULL DEFAULT '0',
  `quantity_decimal` smallint unsigned NOT NULL DEFAULT '0',
  `ask_price` double NOT NULL DEFAULT '0',
  `ask_quantity` double NOT NULL DEFAULT '0',
  `ask_sum` double NOT NULL DEFAULT '0',
  `bid_price` double NOT NULL DEFAULT '0',
  `bid_quantity` double NOT NULL DEFAULT '0',
  `bid_sum` double NOT NULL DEFAULT '0',
  ...
  KEY `product_currency_base_id_fk` (`currency_base_id`),
  KEY `product_currency_quote_id_fk` (`currency_quote_id`),
  KEY `product_platform_fk` (`platform_id`),
  CONSTRAINT `product_currency_base_id_fk` FOREIGN KEY (`currency_base_id`) REFERENCES `currency` (`id`) ON DELETE CASCADE,
  CONSTRAINT `product_currency_quote_id_fk` FOREIGN KEY (`currency_quote_id`) REFERENCES `currency` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `ticker` (
  ...
  `exchange_reference` double NOT NULL DEFAULT '0',
  `exchange_current` double NOT NULL DEFAULT '0',
  `exchange_min` double NOT NULL DEFAULT '0',
  `exchange_max` double NOT NULL DEFAULT '0',
  `value_reference` double NOT NULL DEFAULT '0',
  `value_current` double NOT NULL DEFAULT '0',
...
CREATE TABLE `transaction_quote` (
  ...
  `reference` double NOT NULL DEFAULT '0',
  `price` double NOT NULL,
  `amount` double NOT NULL,
  `subtotal` double NOT NULL,
  `fee` double NOT NULL,
...
CREATE TABLE `wallet` (
  ...
  `amount` double NOT NULL,
  `buy_exchange` double NOT NULL DEFAULT '0',
  `buy_value` double NOT NULL DEFAULT '0',
  `current_exchange` double NOT NULL DEFAULT '0',
  `current_value` double NOT NULL DEFAULT '0',
  `sell_stop` tinyint(1) NOT NULL DEFAULT '0',
  `sell_stop_reference` tinyint(1) NOT NULL DEFAULT '0',
  `sell_stop_amount` double NOT NULL DEFAULT '0',
  `sell_stop_max_exchange` double NOT NULL DEFAULT '0',
  `sell_stop_max_value` double NOT NULL DEFAULT '0',
  `sell_stop_max_percent` double NOT NULL DEFAULT '0',
  `sell_stop_max_at` datetime DEFAULT NULL,
  `sell_stop_max_executable` tinyint(1) NOT NULL DEFAULT '0',
  `sell_stop_min_exchange` double NOT NULL DEFAULT '0',
  `sell_stop_min_value` double NOT NULL DEFAULT '0',
  `sell_stop_min_percent` double NOT NULL DEFAULT '0',
  ...
  `buy_stop_reference` tinyint(1) NOT NULL DEFAULT '0',
  `buy_stop_amount` double NOT NULL DEFAULT '0',
  `buy_stop_max_exchange` double NOT NULL DEFAULT '0',
  `buy_stop_max_value` double NOT NULL DEFAULT '0',
  `buy_stop_max_percent` double NOT NULL DEFAULT '0',
  `buy_stop_max_at` datetime DEFAULT NULL,
  `buy_stop_max_executable` tinyint(1) NOT NULL DEFAULT '0',
  `buy_stop_min_exchange` double NOT NULL DEFAULT '0',
  `buy_stop_min_value` double NOT NULL DEFAULT '0',
  `buy_stop_min_percent` double NOT NULL DEFAULT '0',
  ...
  `sell_stoploss_exchange` double NOT NULL DEFAULT '0',
  `sell_stoploss_value` double NOT NULL DEFAULT '0',
  `sell_stoploss_percent` double NOT NULL DEFAULT '0',
  ...
  `product_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `sell_stop_exchange` double NOT NULL DEFAULT '0',
  `buy_stop_exchange` double NOT NULL DEFAULT '0',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (2,'2021_11_04_231500_wallet_sell_stoploss_executable',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'2021_11_05_1730_platform_seed_kucoin',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2021_11_26_080000_user_investment',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2021_12_30_234500_user_enabled_admin',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2022_01_03_221500_wallet_sell_buy_percent',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2022_01_05_183000_wallet_buy_sell_exchange',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2022_01_10_221500_wallet_history_payload',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2022_01_10_223000_wallet_buy_market',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2022_01_11_083000_wallet_buy_sell_rename',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2022_04_04_231400_wallet_buy_stop_max_follow',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2022_05_16_170000_order_custom',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2024_03_07_230000_forecast_delete',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2024_03_09_150000_platform_trailing_stop',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2024_03_09_151000_order_reference',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2024_03_09_153000_wallet_order_buy_sell_stop_id',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2024_03_26_183000_wallet_buy_market_delete',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2024_04_10_003000_wallet_processing_at',1);
