...
class Scenario extends ControllerAbstract
{
    ...
    protected function dataFromRow(): array
    {
        return [
            ...
            'sell_stop_max_percent_min' => $this->request->input('sell_stop_max_percent_min', $this->row->sell_stop_max_percent - 2),
            'sell_stop_max_percent_max' => $this->request->input('sell_stop_max_percent_max', $this->row->sell_stop_max_percent + 2),
            'sell_stop_min_percent_min' => $this->request->input('sell_stop_min_percent_min', $this->row->sell_stop_min_percent - 2),
            'sell_stop_min_percent_max' => $this->request->input('sell_stop_min_percent_max', $this->row->sell_stop_min_percent + 2),
            ...
            'buy_stop_min_percent_min' => $this->request->input('buy_stop_min_percent_min', $this->row->buy_stop_min_percent - 2),
            'buy_stop_min_percent_max' => $this->request->input('buy_stop_min_percent_max', $this->row->buy_stop_min_percent + 2),
            'buy_stop_max_percent_min' => $this->request->input('buy_stop_max_percent_min', $this->row->buy_stop_max_percent - 2),
            'buy_stop_max_percent_max' => $this->request->input('buy_stop_max_percent_max', $this->row->buy_stop_max_percent + 2),
            ...
            'sell_stoploss_percent_min' => $this->request->input('sell_stoploss_percent_min', $this->row->sell_stoploss_percent - 2),
            'sell_stoploss_percent_max' => $this->request->input('sell_stoploss_percent_max', $this->row->sell_stoploss_percent + 2),
