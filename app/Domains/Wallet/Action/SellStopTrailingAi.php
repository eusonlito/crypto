...
class SellStopTrailingAi extends ActionAbstract
{
    ...
    protected function calculateRequestMessage(): string
    {
        ...
        As an expert financial assistant, analyze the following indicators and data for the :symbol trading pair to recommend the optimal percentages for 'limit' and 'stop' that maximize profit and minimize risk in rapid intraday trading. Please adhere to the following requirements:

        - Trades should be executed within a short time frame.
        - Buying and selling can to occur as quickly as possible.

        Use the data provided below to calculate and recommend the optimal 'limit' and 'stop' percentages to a trailing stop sell operation.
        ...
        **Important Notes:**
        ...
        - 'limit' is the percentage rise in price that triggers the activation of the sell order and must be at least 5.
        - 'stop' is the percentage rebound downward in price required for the order execution after the 'limit' has been reached.
        - 'limit' - 'stop' operation must be at least >= 3 to get a minimum 3% percent profit.
    ...
    protected function updateData(): void
    {
        $this->data = [
            ...
            'sell_stop_max_percent' => $this->values['limit'],
            'sell_stop_min_percent' => $this->values['stop'],
