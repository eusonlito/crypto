<div class="whitespace-nowrap">
    <div class="box p-2">
        ...
        <div class="lg:flex">
            ...
            @if ($row->sell_stop_min && $row->sell_stop_max)
            ...
            <div class="flex flex-1 flex-wrap text-center p-2 border-t lg:border-t-0 lg:border-l border-gray-300 border-dashed">
                <div class="flex-1 p-2">
                    ...
                    <div class="text-gray-600 text-xs mt-2">{{ __('wallet-stat.sell_stop_max') }}</div>

                    <div class="flex items-center justify-center">
                        <div class="text-base mr-2 {{ $sell_stop_max_at ? 'text-theme-10' : '' }}" title="{{ $sell_stop_max_at }}">@number($sell_stop_max)</div>
                        <div class="{{ ($sell_stop_max_exchange_percent >= 0) ? 'text-theme-10' : 'text-theme-24' }} flex text-xs font-medium">
                            ...
                            @icon(($sell_stop_max_exchange_percent < 0) ? 'chevron-down' : 'chevron-up', 'w-4 h-4')
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center">
                        <div class="text-base {{ $sell_stop_max_at ? 'text-theme-10' : '' }}" title="{{ $sell_stop_amount }}x{{ $sell_stop_max }}">@number($sell_stop_max_value)</div>
                    </div>
                ...
                <div class="flex-1 p-2">
                    ...
                    <div class="text-gray-600 text-xs mt-2">{{ __('wallet-stat.sell_stop_min') }}</div>

                    <div class="flex items-center justify-center">
                        <div class="text-base mr-2 {{ $sell_stop_min_at ? 'text-theme-10' : '' }}" title="{{ $sell_stop_min_at }}">@number($sell_stop_min)</div>
                        <div class="{{ ($sell_stop_min_exchange_percent >= 0) ? 'text-theme-10' : 'text-theme-24' }} flex text-xs font-medium">
                            ...
                            @icon(($sell_stop_min_exchange_percent < 0) ? 'chevron-down' : 'chevron-up', 'w-4 h-4')
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center">
                        <div class="text-base {{ $sell_stop_min_at ? 'text-theme-10' : '' }}" title="{{ $sell_stop_amount }}x{{ $sell_stop_min }}">@number($sell_stop_min_value)</div>
                    </div>
            ...
            @if ($row->buy_stop_min && $row->buy_stop_max)
            ...
            <div class="flex flex-1 flex-wrap text-center p-2 border-t lg:border-t-0 lg:border-l border-gray-300 border-dashed">
                <div class="flex-1 p-2">
                    ...
                    <div class="text-gray-600 text-xs mt-2">{{ __('wallet-stat.buy_stop_min') }}</div>
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <div class="{{ ($buy_stop_min_exchange_percent >= 0) ? 'text-theme-24' : 'text-theme-10' }} flex text-xs font-medium">
                            ...
                            @icon(($buy_stop_min_exchange_percent < 0) ? 'chevron-down' : 'chevron-up', 'w-4 h-4')
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center">
                        <div class="text-base {{ $buy_stop_min_at ? 'text-theme-10' : '' }}" title="{{ $buy_stop_amount }}x{{ $buy_stop_min }}">@number($buy_stop_min_value)</div>
                    </div>
                ...
                <div class="flex-1 p-2">
                    ...
                    <div class="text-gray-600 text-xs mt-2">{{ __('wallet-stat.buy_stop_max') }}</div>
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <div class="{{ ($buy_stop_max_exchange_percent >= 0) ? 'text-theme-24' : 'text-theme-10' }} flex text-xs font-medium">
                            ...
                            @icon(($buy_stop_max_exchange_percent < 0) ? 'chevron-down' : 'chevron-up', 'w-4 h-4')
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center">
                        <div class="text-base {{ $buy_stop_max_at ? 'text-theme-10' : '' }}" title="{{ $buy_stop_amount }}x{{ $buy_stop_max }}">@number($buy_stop_max_value)</div>
                    </div>
                ...
                <div class="flex-1 p-2">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <div class="{{ ($sell_stoploss_exchange_percent < 0) ? 'text-theme-24' : 'text-theme-10' }} flex text-xs font-medium">
                            ...
                            @icon(($sell_stoploss_exchange_percent < 0) ? 'chevron-down' : 'chevron-up', 'w-4 h-4')
                        </div>
                    </div>
                </div>
