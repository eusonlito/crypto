    ...
    <div class="box p-5 mt-5">
        <div class="lg:flex">
            ...
            <div class="flex-auto p-2">
                ...
                <input type="number" name="sell_stop_max" step="0.000000001" class="form-control form-control-lg" id="wallet-sell_stop_max" value="{{ $REQUEST->input('sell_stop_max') }}" readonly>
            </div>

            <div class="flex-auto p-2">
                <label for="wallet-sell_stop_min" class="form-label">{{ __('wallet-create.sell_stop_min') }}</label>
                <input type="number" name="sell_stop_min" step="0.000000001" class="form-control form-control-lg" id="wallet-sell_stop_min" value="{{ $REQUEST->input('sell_stop_min') }}" readonly>
            </div>
    ...
    <div class="box p-5 mt-5">
        <div class="lg:flex">
            ...
            <div class="flex-auto p-2">
                ...
                <input type="number" name="buy_stop_min" step="0.000000001" class="form-control form-control-lg" id="wallet-buy_stop_min" value="{{ $REQUEST->input('buy_stop_min') }}" readonly>
            </div>

            <div class="flex-auto p-2">
                <label for="wallet-buy_stop_max" class="form-label">{{ __('wallet-create.buy_stop_max') }}</label>
                <input type="number" name="buy_stop_max" step="0.000000001" class="form-control form-control-lg" id="wallet-buy_stop_max" value="{{ $REQUEST->input('buy_stop_max') }}" readonly>
            </div>
    ...
    <div class="box p-5 mt-5">
        <div class="lg:flex">
            ...
            <div class="flex-auto p-2">
                ...
                <input type="number" name="sell_stoploss_exchange" step="0.000000001" class="form-control form-control-lg" id="wallet-sell_stoploss_exchange" value="{{ $REQUEST->input('sell_stoploss_exchange') }}" readonly>
            </div>
